...
def getTheLowestFromALl (list, list2 ,list3):
   city1 = getTheLowest(list)
   city2 = getTheLowest(list2)
   city3 = getTheLowest(list3)
   if (city1.dataF < city2.dataF and city1.dataF < city3.dataF):
       return 1
   if (city2.dataF < city1.dataF and city2.dataF < city3.dataF):
       return 2
   if (city3.dataF < city1.dataF and city3.dataF < city2.dataF):
       return 3
'''
#---------------------------------------------------------------------------------------------------#
...
print()
find_path(startList, endList, 4, False)
print()
